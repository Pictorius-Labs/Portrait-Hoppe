...
<div class="site_content">
    ...
    ?>
        <div id="new">
            <a href="?site=shop&newShop"><img src="neu.png">Neuen Eintrag erstellen</a>
        </div>
        <br>
            <?php
            ...
            ?>
                ...
                <div class="shop_object">
                    ...
                    <div id="shop_text">
            <?php
                echo "<h3 id='product'>" .$row['product']. "<h3 id='cost'>".$row['cost']."<a href='?site=shop&delShop=".$row['id']."'><img src='löschen.png'></a></h3></h3>";
                echo "";
