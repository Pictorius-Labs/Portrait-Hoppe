<div class="site">
  ...
  <div class="site_content">
    ...
    <div id="new">
      <a href="?site=neuigkeiten&newNews"><img src="img/ic_neu.png">Neuen Eintrag erstellen</a>
    </div>
    <br>
    ...
    <div id="news_text">
      ...
      <?php
        echo "<h3>" .$row['date']. "<a href='?site=neuigkeiten&delNews=".$row['news-id']."'><img src='img/ic_löschen.png'></a></h3>";
