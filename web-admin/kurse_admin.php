<div class="site">
  ...
  <div class="site_content">
    <?php
      ...
      <div id="new">
        <a href="?site=kurse&newKurs"><img src="img/ic_neu.png">Neuen Kurs eintragen</a>
      </div>
      <br>
      ...
      <?php
            echo "<h3>" .$row['title']. "<a href='?site=kurse&delkurs=".$row['kurs-id']."'><img src='img/ic_löschen.png'></a></h3>";
