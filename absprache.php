...
<form id="formular" action="absprache.php" method="get">
  ...
  <input id="name" placeholder="Name" name="name" size="25" type="text" required/><br />
  <input id="email" placeholder="Email" name="email" size="25" type="text" required/><br />
  <input id="betreff" placeholder="Betreff" name="betreff" size="25" type="text" required/><br />
  <textarea id="nachricht" placeholder="Nachricht hier eingeben..."cols="50" rows="6" name="nachricht"required></textarea><br />
